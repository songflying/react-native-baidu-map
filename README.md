# react-native-baidu-map-lech [![npm version](https://img.shields.io/npm/v/react-native-baidu-map-lech.svg?style=flat)](https://www.npmjs.com/package/react-native-baidu-map-lech)

Baidu Map SDK modules and view for React Native(Android & IOS), support react native 0.47+

百度地图 React Native 模块，支持 react native 0.47+

![Android](https://raw.githubusercontent.com/songflying/react-native-baidu-map-lech/master/images/android.jpg)
![IOS](https://raw.githubusercontent.com/songflying/react-native-baidu-map-lech/master/images/ios.jpg)

### Install 安装
    npm install react-native-baidu-map-lech --save
### Import 导入

#### Android Studio
- settings.gradle `
include ':react-native-baidu-map-lech'
project(':react-native-baidu-map-lech').projectDir = new File(settingsDir, '../node_modules/react-native-baidu-map-lech/android')`

- build.gradle `compile project(':react-native-baidu-map-lech')`

- MainApplication`new BaiduMapPackage(getApplicationContext())`
- AndroidMainifest.xml `<meta-data
            android:name="com.baidu.lbsapi.API_KEY" android:value="xxx"/>`

#### Xcode
- Project navigator->Libraries->Add Files to 选择 react-native-baidu-map-lech/ios/RCTBaiduMap.xcodeproj
- Project navigator->Build Phases->Link Binary With Libraries 加入 libRCTBaiduMap.a
- Project navigator->Build Settings->Search Paths， Framework search paths 添加 react-native-baidu-map/ios/lib，Header search paths 添加 react-native-baidu-map-lech/ios/RCTBaiduMap
